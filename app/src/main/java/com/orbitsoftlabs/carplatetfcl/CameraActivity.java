...
import com.orbitsoftlabs.carplatetfcl.env.ImageUtils;
import com.orbitsoftlabs.carplatetfcl.env.Logger;
import com.orbitsoftlabs.carplatetfcl.Classifier.Device;
import com.orbitsoftlabs.carplatetfcl.Classifier.Model;
import com.orbitsoftlabs.carplatetfcl.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private void sendSMS(String ACCOUNT_SID, String AUTH_TOKEN, String plate ){
    //is violating Provincial Ordinance No. 164 also known as Number Coding Scheme Ordinance of the Province of Cavite.
    String body = plate+" is violating Provincial Ordinance No. 164";
    String from = "+15094040759";
  ...
  @UiThread
  protected void showResultsInBottomSheet(List<Recognition> results, String recognized_text) {
    if (results != null && results.size() >= 3) {
      ...
      if(!new_recognized_text.equals("")){
        ...
        Toast.makeText(getApplicationContext(), "No Plate Number Detected", Toast.LENGTH_SHORT).show();
      }
      if (recognition != null) {
